...
class csp_tx_recording(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "csp_tx_recording")
        ...
        self.soapy_hackrf_sink_0.set_frequency(0, 437e6+ 371200)
        ...
        self.blocks_file_source_1 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/thomas/Documents/GitRepos/disco_gnuradio/ping_recording_disco1_to_gs.raw', True, 0, 0)
...
def main(top_block_cls=csp_tx_recording, options=None):
